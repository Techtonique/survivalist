...
The User Guide covers the most important aspects of doing to survival analysis with survivalist.
...
Users new to survivalist should read :ref:`understanding_predictions` to get familiar with the basic concepts.
The interactive guide :ref:`/user_guide/00-introduction.ipynb` gives a brief overview of how to use survivalist for survival analysis.
